...
?>
<div id="detail">
  <h1  align="center">Homes for you</h1>
    <table >
      <tr >
        <td >
            <img src="images/ourmoto.jpg" alt="Gary" />           
        </td>
        <td  >
            <h1 id="hr">Our moto</h1>
      ...
      <tr  style="background-color:rgba(255,255,255,1)">
        ...
        <td >
        	<img src="images/user.jpg" alt="Rahul" />
            </td>
     </tr>

      <tr  style="background-color:rgba(255,255,255,1)">
        <td >
            <img src="images/agent.jpg" alt="Heth" />           
        </td>
        <td  >
            <h1 id="hr">Agent</h1>
